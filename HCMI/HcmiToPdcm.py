...
def generate_sharing(hcmiDf, sharing_template):
    ...
    sharing_columns_rename_map = {"Name":"model_id", "Link to Model Details": "database_url", "Licensing Required For Commercial Use": "accessibility" }
    ...
    HCMI_sharing_sheet['accessibility'] = HCMI_sharing_sheet['accessibility'].apply(lambda x: "academia" if x == "Yes" else "industry and academia")
    HCMI_sharing_sheet['provider_name'] = "Human Cancer Models Initiative"
    HCMI_sharing_sheet['provider_abbreviation'] = "HCMI"
...
generate_sample_sheet(hcmiDf, sample_template)
